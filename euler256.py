...
Assuming that the only type of available tatami has dimensions 1times2 
...
dimensions <var>a</var> <var>b</var> and even size <var>s</var>  <var>
a</var>middot<var>b</var>
We use the term size to denote the floor surface area of the room and 
mdash without loss of generality mdash we add the condition <var>a
</var> le <var>b</var>

There is one rule to follow when laying out tatami there must be no 
points where corners of four different mats meet
For example consider the two arrangements below for a 4times4 room
<div align='center'><img src="project/images/p256_tatami3.gif" />
"""
